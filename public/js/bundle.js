        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              ...
              location.assign('/'); // this will reload the page and override cookie will be sent from user
...
exports.updateUserDataAndPassword = void 0;
...
var UPDATE_DATA_END_POINT = "".concat(BASE_URL, "api/v1/users/updateMe");
var UPDATE_PASSWORD_END_POINT = "".concat(BASE_URL, "api/v1/users/updatePassword"); //type is either data(name,email) or password

var updateUserDataAndPassword = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? UPDATE_PASSWORD_END_POINT : UPDATE_DATA_END_POINT;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  return function updateUserDataAndPassword(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateUserDataAndPassword = updateUserDataAndPassword;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FjaGluMTAwNCIsImEiOiJjazlmeTYzcXMwYXhhM2ZrY2lxeWJ0bmQ2In0.eCU5o633Ij45NqmnFTqBRQ';
...
var stripe = Stripe('pk_test_VVA1eT92UEJz1HOPWB1aZMXH00GZOIsFRl'); // public key from stripe
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var form = new FormData(); // creating multipart form and appending data to it.

    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateUserData.updateUserDataAndPassword)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateUserData.updateUserDataAndPassword)({
